	...
	public void handle(ActionEvent event) {
		...
		if(number1 == "") {
			if (value == "*" || value == "/" || value == "=" || value == "+" || value == "-") {
				displayText.setText("Ingrese un numero antes del operador");
			} else if (value == "C"){
				displayText.setText("");
			...
			if (number2=="" &&(value == "*" || value == "/" || value == "+" || value == "-")) {
				...
				switch (operator){
					case "+":
						resul = num1+num2;
						displayText.setText(String.valueOf(resul));
						number1 ="";
						number2= "";
						operator=null;
						break;
					...
					case "/":
						if(num2==0){
							displayText.setText("¡Error! Division por 0");
							number1 = "";
							number2 = "";
							operator = null;
						}else {
